...
/*  TAG 			ENTRY TYPE		LENGTH 						FLAGS 	READ FORMAT 	WRITE FORMAT */
	...
	{"ipv4_ver", 	ET_FLAG,		E_BITS("ipv4_vhl", 0, 4), 	0, 		ERF_UINT_LE, 	EWF_HEX_STR},
	{"ipv4_ihl", 	ET_FLAG,		E_BITS("ipv4_vhl", 4, 4), 	EF_32BIT_MUL, 	ERF_UINT_LE, 	EWF_HEX_STR},
	...
	{"ipv4_len", 	ET_DATAFIELD,	E_LEN(2), 					0, 		ERF_UINT_LE, 	EWF_HEX_STR},
	{"ipv4_id", 	ET_DATAFIELD,	E_LEN(2), 					0, 		ERF_UINT_LE, 	EWF_HEX_STR},
	...
	{"ipv4_ttl", 	ET_DATAFIELD,	E_LEN(1), 					0, 		ERF_UINT_LE, 	EWF_HEX_STR},
	{"ipv4_proto", 	ET_DATAFIELD,	E_LEN(1), 					0, 		ERF_UINT_LE, 	EWF_HEX_STR},
	{"ipv4_cksum", 	ET_DATAFIELD,	E_LEN(2), 					0, 		ERF_UINT_LE, 	EWF_HEX_STR},
	...
	/*{"ipv4_src", 	ET_DATAFIELD,	E_LEN(4), 					0, 		ERF_UINT_LE, 	EWF_UINT},*/
	/*{"ipv4_dest", 	ET_DATAFIELD,	E_LEN(4), 					0, 		ERF_UINT_LE, 	EWF_UINT},*/
	/*{"ipv4_opt", 	ET_DATAFIELD,	E_PAC_OFF_OF("ipv4_ihl"),	EF_OPT,	ERF_UINT_LE, 	EWF_UINT},*/
}; 
