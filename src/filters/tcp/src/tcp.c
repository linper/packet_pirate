...
/*  TAG 			ENTRY TYPE		LENGTH 					FLAGS 		READ FORMAT 	WRITE FORMAT */
	...
	{"tcp_flg", 	ET_BITFIELD, 	E_LEN(2), 				EF_NOWRT, 	ERF_BIN, 		EWF_RAW},
	{"tcp_dt_off", 	ET_FLAG,		E_BITS("tcp_flg", 0, 4),EF_32BITW, 	ERF_UINT_LE, 	EWF_UINT},
	{"tcp_rez", 	ET_FLAG,		E_BITS("tcp_flg", 4, 3),EF_NOWRT, 	ERF_UINT_LE, 	EWF_UINT},
	...
	{"tcp_win", 	ET_DATAFIELD, 	E_LEN(2), 				0, 			ERF_UINT_LE, 	EWF_UINT},
	{"tcp_cksum", 	ET_DATAFIELD, 	E_LEN(2), 				0, 			ERF_UINT_LE, 	EWF_UINT},
	{"tcp_urgp", 	ET_DATAFIELD, 	E_LEN(2), 				0, 			ERF_UINT_LE, 	EWF_UINT},
	{"tcp_opt", 	ET_DATAFIELD,	E_PAC_OFF_OF("tcp_sport", "tcp_dt_off"),EF_OPT,	ERF_BIN, EWF_HEXDUMP},
	{"tcp_pld", 	ET_DATAFIELD,	E_PAC_OFF_OF("ipv4_vhl", "ipv4_len"),	EF_PLD | EF_NOWRT,	ERF_BIN, 	EWF_RAW},
}; 
